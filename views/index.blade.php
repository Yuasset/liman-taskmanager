...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link" onclick="viewLists()" href="#listele" data-toggle="tab"> 
            <i class="fas fa-tasks"></i> {{ __("LS Listele") }}
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" onclick="whoami()" href="#bul" data-toggle="tab"> 
...
<div class="tab-content">
    ...
    <div id="listele" class="tab-pane">
        @include('viewlists.main')
    </div>
    <div id="bul" class="tab-pane">
        @include('whoami.main')
    </div>
</div>
@endsection